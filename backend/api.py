...
app = Flask(__name__)
cors = CORS(app, resources={r"/*": {"origins": ["http://localhost:5173", "http://sasgui.cse.uconn.edu:5173","sasgui.cse.uconn.edu:5173", "http://sasgui.cse.uconn.edu", "sasgui.cse.uconn.edu"]}})
