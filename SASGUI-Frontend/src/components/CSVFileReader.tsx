...
export interface csvCurveData {"":String, ICsv:number, q:number};
            ...
            Papa.parse(e.target.files[0], {//Parse the files
                complete: function(results) {
                    if(results?.data !== null){
                        ...
                        resCurve = resCurve.filter((x:{"":String, ICsv:number, q:number}) => (!Number.isNaN(x.ICsv) && typeof x.ICsv !== 'string') || (!Number.isNaN(x.q) && typeof x.q !== 'string'))
